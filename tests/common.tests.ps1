...
Pester\Describe "Manifest" {
    ...
    Pester\It "has a valid guid" {
        $ManifestHash.Guid | Should Be "8cee40d3-f4db-4a0f-80ca-6655ca11bfbe"
    }
    ...
    Pester\It 'has a valid license Uri' {
        $ManifestHash.PrivateData.Values.LicenseUri | Should Be "https://github.com/lazywinadmin/BloggerPS/blob/master/BloggerPS/license"
    }
    
    Pester\It 'has a valid project Uri' {
        $ManifestHash.PrivateData.Values.ProjectUri | Should Be "https://github.com/lazywinadmin/BloggerPS"
    }
